...
## Covid 19 adaptation: different directories, usage of f-string formatting
## no more batches, removal of human specific stuff
## command line interface change to job id is now just a running number 1-24, and a job file that takes the sample file from the
## corresponding line
...
class Pipeline:
    ...
    def qualimap(self, blocking=False):
        ...
        qmCmd = ['%s/qualimap' % qualimapDir, 'bamqc', '-bam', bamFile, '-outdir', self.dirs['qualimapOutdir'], '--java-mem-size=32G']
